    ...
    return (
      <main className="flex min-h-[100dvh] flex-col items-center justify-center gap-8 bg-gray-50">
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="w-80 rounded-xl border-2 border-gray-300 px-8 py-3 text-center text-lg font-medium">
            <p>
        ...
        <button
          type="button"
          className="rounded-xl border-2 border-green-600 bg-green-500 px-6 py-3 font-medium text-white shadow-sm transition-all hover:-translate-y-1"
          onClick={() => {
            setHistory([]);
            setQuestionList(QUESTIONS);
            setQuestion(getRandomQuestion());
  ...
  return (
    <main className={"flex min-h-[100dvh] flex-col bg-gray-100"}>
      ...
      {(editorState === EditorState.AnswerCorrect ||
        ...
        <footer
          className={
            "-mx-[2px] animate-slidein overflow-hidden rounded-t-2xl border-2 border-b-0 bg-white px-8 py-8 transition-all duration-500"
          }
        >
          <div className="container mx-auto">
            <div className="flex w-full items-center justify-between">
              ...
              <button
                type="submit"
                onClick={() => onNext()}
                className="rounded-xl border-2 border-blue-600 bg-blue-500 px-6 py-3 font-medium text-white shadow-sm transition-all hover:-translate-y-1"
              >
                Next
              </button>
            </div>
